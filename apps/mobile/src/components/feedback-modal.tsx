...
const tone: Record<
  Mode,
  { bg: string; text: string; button: "danger" | "primary" | "success" }
> = {
  error: {
    ...
    >
      <View style={modalStyles.backdrop}>
        <View accessibilityViewIsModal style={modalStyles.card}>
          <View style={[modalStyles.badge, { backgroundColor: tone[mode].bg }]}>
...
export function ErrorModal(
  props: Omit<React.ComponentProps<typeof FeedbackModal>, "mode">,
) {
